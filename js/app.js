...
function buildProductCard(p) {
  ...
  return '<div class="product-card" data-id="' + safeId + '">'
    ...
    + 'trackRecentlyViewed({id:\\\'\'' + safeId + '\'\\\',name:\\\'\'' + safeName + '\'\\\',price:\'' + safePrice + '\',image:\\\'\'' + safeImage + '\'\\\',shipping_cost:\'' + (parseFloat(p.shipping_cost)||0) + '\'});addToCart({id:\\\'\'' + safeId + '\'\\\',name:\\\'\'' + safeName + '\'\\\',price:\'' + safePrice + '\',image:\\\'\'' + safeImage + '\'\\\',shipping_cost:\'' + (parseFloat(p.shipping_cost)||0) + '\'})\'">Add to Cart</button>')=========================================
   HAMMOND HOMESTEAD — Main App JS
   ============================================================ */
